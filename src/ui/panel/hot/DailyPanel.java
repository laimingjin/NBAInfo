...
public class DailyPanel extends Hot {
...
class ButtonListener extends MouseAdapter {
  ...
  DailyPanel currentPanel;

	public ButtonListener(int id, DailyPanel panel) {
		buttonID = id;
		currentPanel = panel;
 ...
 */
	public void mouseClicked(MouseEvent e) {
		...
		hotBLService.getHotPointPlayerToday(TypeOfSort4HotPointPlayer.SCORING);
		   ...
		   percent_shoting.turnBack();
		   percent_three.turnBack();
			arrTotalVOs=hotBLService.getHotPointPlayerToday(TypeOfSort4HotPointPlayer.REBOUND);
		   ...
		   percent_shoting.turnBack();
		   percent_three.turnBack();
			arrTotalVOs=hotBLService.getHotPointPlayerToday(TypeOfSort4HotPointPlayer.ASSIST);
		   ...
		   percent_shoting.turnBack();
		   percent_three.turnBack();
			arrTotalVOs=hotBLService.getHotPointPlayerToday(TypeOfSort4HotPointPlayer.BLOCK);
		 ...
		 block.turnBack();
		   ...
		   percent_shoting.turnBack();
		   percent_three.turnBack();
			arrTotalVOs=hotBLService.getHotPointPlayerToday(TypeOfSort4HotPointPlayer.STLSv_STEALS);
		 ...
		 steal.turnBack();
		   percent_freethrow.turnBack();
		   percent_shoting.turnBack();
			arrTotalVOs=hotBLService.getHotPointPlayerToday(TypeOfSort4HotPointPlayer.TPPer);
		 ...
		 steal.turnBack();
		   percent_freethrow.turnBack();
		percent_three.turnBack();
			arrTotalVOs=hotBLService.getHotPointPlayerToday(TypeOfSort4HotPointPlayer.FGPer);
		 ...
		 steal.turnBack();
		   percent_three.turnBack();
		   percent_shoting.turnBack();
			arrTotalVOs=hotBLService.getHotPointPlayerToday(TypeOfSort4HotPointPlayer.FTPer);
		}
		  paintTotalTable();
	}
}

	public DailyPanel(JPanel lastJPanel, Frame current, ArrayList<PlayerBasicVO> playerBasicVOs) {
