...
public class MostPanel extends Hot {
...
class ButtonListener extends MouseAdapter {
	...
	MostPanel currentPanel;

	public ButtonListener(int id, MostPanel panel) {
		buttonID = id;
		currentPanel = panel;
 ...
 */
	public void mouseClicked(MouseEvent e) {
		...
		if(labelName[buttonID].equals("得分")){
		   ...
		   percent_three.turnBack();
			...
			arrTotalVOs=	    hotBLService.getMostImprovedPlayer(TypeOfSort4MostImprovedPlayer.AVERAGE_PSCORING);
		   ...
		   percent_shoting.turnBack();
		   percent_three.turnBack();
			arrTotalVOs=	   hotBLService.getMostImprovedPlayer(TypeOfSort4MostImprovedPlayer.AVERAGE_REBOUND);
		   ...
		   percent_shoting.turnBack();
		   percent_three.turnBack();
			arrTotalVOs=	   hotBLService.getMostImprovedPlayer(TypeOfSort4MostImprovedPlayer.AVERAGE_ASSIST);
		   ...
		   percent_shoting.turnBack();
		   percent_three.turnBack();
			arrTotalVOs=	   hotBLService.getMostImprovedPlayer(TypeOfSort4MostImprovedPlayer.AVERAGE_BLOCK);
		 ...
		 block.turnBack();
		   ...
		   percent_shoting.turnBack();
		   percent_three.turnBack();
			arrTotalVOs=	   hotBLService.getMostImprovedPlayer(TypeOfSort4MostImprovedPlayer.AVERAGE_STLS_STEALS);
		 ...
		 steal.turnBack();
		   percent_freethrow.turnBack();
		   percent_shoting.turnBack();
			arrTotalVOs=	   hotBLService.getMostImprovedPlayer(TypeOfSort4MostImprovedPlayer.AVERAGE_THREEPOINT);
		 ...
		 steal.turnBack();
		   percent_freethrow.turnBack();
		percent_three.turnBack();
			arrTotalVOs=	   hotBLService.getMostImprovedPlayer(TypeOfSort4MostImprovedPlayer.AVERAGE_SHOTING);
		 ...
		 steal.turnBack();
		   percent_three.turnBack();
		   percent_shoting.turnBack();
			arrTotalVOs=	   hotBLService.getMostImprovedPlayer(TypeOfSort4MostImprovedPlayer.AVERAGE_FREETHROW);
	...
	public MostPanel(JPanel lastJPanel, Frame current, ArrayList<PlayerBasicVO> playerBasicVOs) {
