...
public class PlayerLowData_allStar_read {
	...
	public static ArrayList<PlayerTotalPO> read(String fileName) throws IOException{
		ArrayList<PlayerTotalPO> list=new ArrayList<PlayerTotalPO>();
		TypeOfMatch matchType=TypeOfMatch.ALLSTAR;//比赛类型
		...
		while((line=br.readLine())!=null){
			if(line.startsWith("SeasonTotalsAllStarSeason")){
			break;
	...
	public static void main(String[]args) throws IOException{
		...
		String line="";
		BufferedWriter bw=new BufferedWriter(new FileWriter("D://playerAllStar.txt"));
...
//		System.out.println(pos.get(0).getTeamName());
//		System.out.println(pos.get(1).getPlayerName());
//		System.out.println(pos.get(1).getShotPer());
	}
}
