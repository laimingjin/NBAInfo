...
/**
 *@author:小春
 *@date:2015年5月20日上午12:15:29
 *@version
 */

public class TeamInMatchVO {
	...
	public TeamInMatchVO(String gameID,String matchDate, TypeOfMatch matchType,
...
public String getTeamID(){
	...
	public TeamInMatchVO(TeamInMatchPO po){
		...
		this.isWin=po.getIsWin();
		this.numOfPlayer = po.getNumOfPlayer();
		FGA = po.getFGA();
		FGM = po.getFGM();
		FGPer = po.getFGPer();
		TPA = po.getTPA();
